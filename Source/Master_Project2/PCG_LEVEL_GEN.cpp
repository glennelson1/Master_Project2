...
#include "PCG_LEVEL_GEN.h"

// Sets default values
APCG_LEVEL_GEN::APCG_LEVEL_GEN()
{
...
void APCG_LEVEL_GEN::BeginPlay()
{
	Super::BeginPlay();
	
}

void APCG_LEVEL_GEN::DeleteGrid()
{
...
void APCG_LEVEL_GEN::SpawnFloor(int loc)
{
...
void APCG_LEVEL_GEN::SpawnBricks(int loc)
{
...
void APCG_LEVEL_GEN::SpawnOb(int loc)
{
	int32 RandomInt= FMath::RandRange(0, 20);
	RandomChoices.Add(RandomInt);
...
void APCG_LEVEL_GEN::SpawnPlatforms(int loc)
{
...
FString APCG_LEVEL_GEN::GenerateSeed()
{
	FString Seed;
...
void APCG_LEVEL_GEN::SaveSeedToFile(const FString& Seed)
{
...
// Called every frame
void APCG_LEVEL_GEN::Tick(float DeltaTime)
{
