...
#include "Level_Creater.h"

// Sets default values
ALevel_Creater::ALevel_Creater()
{
...
void ALevel_Creater::BeginPlay()
{
	Super::BeginPlay();
	
}

void ALevel_Creater::GenerateLevelFromChoices(const TArray<int32>& Choices)
{
...
void ALevel_Creater::LoadLevelFromSeed()
{
	UE_LOG(LogTemp, Warning, TEXT("The Actor's name is %s"), *Seed);
	TArray<FString> SeedValues;
	Seed.ParseIntoArray(SeedValues, TEXT(","), true);
...
void ALevel_Creater::DeleteGrid()
{
...
// Called every frame
void ALevel_Creater::Tick(float DeltaTime)
{
